...
com.wiris.js.JsPluginViewer.prototype = {
	...
	,callService: function(mml,servicename) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 518, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 520, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
	...
	,callShowimage: function(mml,img) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 457, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("GET:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 459, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		con.open("GET",url + data,false);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		con.send(null);
		...
		if(result.height > 0) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "JsPluginViewer.hx", lineNumber : 481, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
			img.style.verticalAlign = "-" + (result.height - result.baseline) + "px";
	...
	,callCreateImage: function(mml,img) {
		...
		data += "&lang=" + this.lang;
		if(this.zoom != 1) data += "&zoom=" + this.zoom;
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 383, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 385, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		con.open("POST",url,false);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		con.send(data);
		var s = con.responseText;
		...
		if(i >= 0) {
			...
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(h.get("formula"),{ fileName : "JsPluginViewer.hx", lineNumber : 408, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		...
		if(height > 0) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "JsPluginViewer.hx", lineNumber : 419, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
	...
	,processMathML: function(mml,container) {
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(mml,{ fileName : "JsPluginViewer.hx", lineNumber : 335, className : "com.wiris.js.JsPluginViewer", methodName : "processMathML"});
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(img.src,{ fileName : "JsPluginViewer.hx", lineNumber : 349, className : "com.wiris.js.JsPluginViewer", methodName : "processMathML"});
	}
	...
	,replaceNodes: function(mathNodes,n) {
		...
		if(browser.getBrowser() == "Explorer" && (browser.getVersion() == "6" || browser.getVersion() == "7") && navigator.appVersion.indexOf("Trident") == -1) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Is ie7",{ fileName : "JsPluginViewer.hx", lineNumber : 234, className : "com.wiris.js.JsPluginViewer", methodName : "replaceNodes"});
	...
	,doLoad: function() {
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("doLoad",{ fileName : "JsPluginViewer.hx", lineNumber : 103, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
		...
		while(_g1 < _g) {
			...
			if(j >= 0) {
				...
				if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(this.baseURL,{ fileName : "JsPluginViewer.hx", lineNumber : 122, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
			}
		}
		...
		this.ready = true;
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Tech:" + this.tech,{ fileName : "JsPluginViewer.hx", lineNumber : 153, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Language:" + this.lang,{ fileName : "JsPluginViewer.hx", lineNumber : 184, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
